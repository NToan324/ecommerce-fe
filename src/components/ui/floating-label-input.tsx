...
const FloatingTextarea = React.forwardRef<HTMLTextAreaElement, React.TextareaHTMLAttributes<HTMLTextAreaElement>>(
  ({ className, ...props }, ref) => {
    return <Textarea cols={4} rows={4} placeholder="" className={cn('peer', className)} ref={ref} {...props} />
  }
)
