    ...
    <div className=''>
      ...
      <div className='relative flex flex-col items-center justify-center gap-10 overflow-hidden p-7 lg:justify-start lg:p-[120px]'>
        ...
        <div className='flex flex-col items-center justify-between gap-10 lg:flex-row'>
          <p className='line-clamp-5 w-full text-justify text-base leading-7 font-medium lg:w-1/2'>
        ...
        <div className='from-blue-primary absolute top-[160px] right-[400px] -z-10 h-[100px] w-[100px] rounded-full bg-gradient-to-br to-white blur-md'></div>
