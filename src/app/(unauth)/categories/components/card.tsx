...
export default function CardProduct() {
  return (
    <div className="min-w-[170px] max-h-[230px] md:max-h-full bg-white hover:z-10 hover:shadow-2xl relative hover:bg-gradient-to-br overflow-hidden from-blue-primary to-white transition-all group hover:scale-125 duration-300 origin-top-left h-[360px] p-4 pb-0 w-full gap-4 rounded-2xl flex flex-col justify-between items-start md:max-w-[300px] border border-black/10">
